  ...
  <Section>
    <div className="grid gap-16 grid-cols-1 md:grid-cols-2">
      <div className="space-y-8">
        ...
        <p>
          I gained valuable experience through my internships and implication within startups. These experiences have
          helped me to grow as a person and to acquire new skills.
        </p>
        <p>
